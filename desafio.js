...
const jugadorUno = {
 ...
 // }
  ...
  var resultado = {
    ...
    ganador: contadorPuntosJug1 == contadorPuntosJug2 ? "empate" : contadorPuntosJug1 > contadorPuntosJug2 ? jugadorUno.nombre : jugadorDos.nombre,
  };

  console.log(resultado);

//  console.log(jugadorUno.nombre + " ha conseguido " + contadorPuntosJug1 + " puntos");
//  console.log(jugadorDos.nombre + " ha conseguido " + contadorPuntosJug2 + " puntos");

//  if (resultado.ganador == "empate") {
//    console.log("El juego ha terminado en un empate!");
//  } else {
//    console.log(resultado.ganador + " ha ganado este juego");
//  };
  //-----------------------------------------------------------------------//
